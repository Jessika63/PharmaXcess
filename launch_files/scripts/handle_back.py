...
def handle_back(backend_folder, db_dump_date, db_container_name, back_app_container_name, no_cache=False):
    ...
    # Step 2: Wait for the doctors database container to be ready
    verify_database_is_up(db_container_name, nb_of_retry=10)

    # Step 2b: Wait for the app database container to be ready
    verify_database_is_up("app-backend-db", nb_of_retry=10)
