...
troubleshooting_message_front_install = (
    "Frontend dependencies are missing (either 'node_modules' or 'package-lock.json').\n\n"
    "Next steps:\n"
    "1. Run 'npm install' inside the 'dispenser_frontend' folder, then relaunch the front.\n"
    "2. Or rerun the launcher with the flag '--install-front' to perform the install automatically.\n"
)
