...
# CREATE
@allergies_bp.route("/allergies", methods=["POST"])
def create_allergy():
...
# GET ALL (by user)
@allergies_bp.route("/allergies/<int:user_id>", methods=["GET"])
...
# GET ONE
@allergies_bp.route("/allergy/<int:allergy_id>", methods=["GET"])
...
# UPDATE
@allergies_bp.route("/allergy/<int:allergy_id>", methods=["PUT"])
...
# DELETE
@allergies_bp.route("/allergy/<int:allergy_id>", methods=["DELETE"])
