...
def test_take_picture_success(client, mocker):
    """
    Objectif: Test the /take_picture endpoint for successful image capture using an external script.
...
def test_take_picture_script_error(client, mocker):
    """
    Objectif: Test the /take_picture endpoint when the external script returns an error during image capture.
...
def test_take_picture_unexpected_exception(client, mocker):
    """
    Objectif: Test the /take_picture endpoint when an unexpected exception occurs during the image capture process.
