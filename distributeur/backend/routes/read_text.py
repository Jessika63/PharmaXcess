...
import traceback  # ← ajoute en haut
...
def extract_text():
    try:
        ...
        result = extractAll.main(image_data, doc_type, is_bytes=True)

        return jsonify(result), 200

    except Exception as e:
        print("[ERROR extract_text route]", e)
        traceback.print_exc()  # ← ajoute cette ligne pour voir la trace complète !
